...
[簡介影片 Introduction video](https://www.youtube.com/watch?v=LVtBhEpdLYw)
...
-------------
	1. \l86duntu\home\dmp\UI_display
		...
		The UI_display is the use of SDL to draw graphical interface, providing touch function,
	...
	2. \l86duntu\home\dmp\TFT_display
		...
		but it can remind the user watering, and the use of TFT LCD as a simple screen, and site functions are the same.
	...
	3. \l86duntu\home\dmp\plant
		...
		We have also created a website on L86duintu where you can see all the values (eg humidity, water, temperature ...)
	...
	4. \l86duntu\etc\init.d\plant
		...
		This script allows us to start automatically when the boot all the programs, and automatic identification function, 
		the details can see my blog in the introduction.
